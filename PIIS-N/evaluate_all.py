...
parser.add_argument('--gpu', default=3, type=int,
                    help='GPU id to use.')
parser.add_argument('--datasets', default=["university"],
...
parser.add_argument('--checkpoint',
                    default="/data3/limian1/Documents/ComplexUAV/ComplexUAV-master/result/convnext_b/university/2025-09-23-11-55-06/model_best_2_0.9388.pth.tar",
